  ...
  return (
    <section aria-labelledby="indicadores">
      <div className="mb-3 flex items-center justify-between gap-3">
        <h2 id="indicadores" className="rotulo">Pulso da clínica</h2>
        <span className="hidden text-xs text-outline sm:inline">Atualizado com os dados de hoje</span>
      </div>
