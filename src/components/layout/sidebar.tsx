      ...
      >
        <div className="flex min-h-[var(--altura-barra)] items-center justify-between gap-3 border-b border-card-border px-4">
          <div className="flex min-w-0 items-center gap-2.5">
            <span aria-hidden="true" className="flex size-9 shrink-0 items-center justify-center rounded-[var(--radius-controle)] bg-primary-container text-[0.8rem] font-bold text-on-primary">
              {CLINICA.monograma}
            </span>
