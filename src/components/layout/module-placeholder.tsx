      ...
      <Card className="relative overflow-hidden">
        <CardCorpo className="relative px-5 py-7 sm:px-7 sm:py-8">
          <div className="grid gap-7 lg:grid-cols-[minmax(0,1fr)_19rem] lg:items-start">
              ...
              {item.proximosPassos.length > 0 ? (
                <div className="mt-6">
                  <div className="mb-3 flex items-center justify-between gap-3">
                    ...
                    <span className="tabular rounded-full border border-card-border bg-surface px-2.5 py-1 text-[0.66rem] font-semibold text-outline">
                  ...
                  <ul className="grid gap-3 sm:grid-cols-2">
                    {item.proximosPassos.map((passo, indice) => (
                      <li
                        ...
                        className="dashboard-stagger premium-interactive group relative flex items-start gap-3 overflow-hidden rounded-[var(--radius-painel)] border border-card-border bg-surface px-4 py-3.5 text-sm leading-6 text-on-surface-variant"
                      >
                        <span className="relative mt-0.5 flex size-7 shrink-0 items-center justify-center rounded-[var(--radius-controle)] border border-primary-fixed bg-selecao text-primary transition-transform duration-200">
            ...
            <aside className="relative overflow-hidden rounded-[var(--radius-painel)] border border-dashed border-outline-variant bg-surface p-5">
              <span className="relative flex size-11 items-center justify-center rounded-[var(--radius-painel)] border border-card-border bg-surface text-outline">
