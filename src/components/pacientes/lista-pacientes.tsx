...
function LinhaPaciente({ paciente, indice }: { paciente: PacienteDaLista; indice: number }) {
  ...
  return (
    <li
      ...
      className={cn(
        "dashboard-stagger premium-interactive group relative isolate flex items-center gap-4 overflow-hidden rounded-[var(--radius-painel)] border p-4 focus-within:border-primary has-[:focus-visible]:outline-2 has-[:focus-visible]:outline-offset-2 has-[:focus-visible]:outline-primary sm:p-5",
        paciente.ativo
