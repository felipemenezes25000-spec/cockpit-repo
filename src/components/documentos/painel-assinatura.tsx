  ...
  return (
    <form action={enviar}>
      ...
      <CardCorpo className="flex flex-col gap-5">
        <p className="rounded-[var(--radius-cartao)] border border-informativo-borda bg-informativo-fundo px-4 py-3 text-sm leading-6 text-on-surface-variant">
        ...
        <div className="rounded-[var(--radius-painel)] border border-card-border bg-surface p-4">
          <label className="group/consentimento flex cursor-pointer items-start gap-3 text-sm leading-6 text-on-surface">
            ...
            <span className="mt-0.5 flex size-5 shrink-0 items-center justify-center rounded-[var(--radius-tag)] border border-outline-variant bg-surface text-transparent transition-[transform,background-color,border-color,color] duration-150 peer-checked:border-primary-container peer-checked:bg-primary-container peer-checked:text-on-primary peer-focus-visible:ring-2 peer-focus-visible:ring-primary peer-focus-visible:ring-offset-2 group-hover/consentimento:border-primary-fixed-dim peer-checked:[&_svg]:scale-100">
