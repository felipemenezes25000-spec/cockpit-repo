    ...
    <ul aria-label="Vendas" className="grid gap-3 lg:grid-cols-2">
      {vendas.map((venda) => (
        <li
          ...
          className="premium-interactive group relative isolate flex min-h-40 flex-col overflow-hidden rounded-[var(--radius-painel)] border border-card-border bg-surface p-4 focus-within:border-primary has-[:focus-visible]:outline-2 has-[:focus-visible]:outline-offset-2 has-[:focus-visible]:outline-primary"
        >
