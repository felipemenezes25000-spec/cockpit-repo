...
<img src="docs/assets/numeros.svg" width="100%" alt="31 migrações SQL versionadas · 42 rotas testadas em 3 larguras · 905 testes de unidade e componente · 269 asserções de permissão no banco · 47 testes de fluxo E2E · 3 perfis com RLS em toda tabela">
...
| Verificações automatizadas | **1485** — 905 Vitest · 269 SQL por perfil · 311 Playwright (260 Chromium, 47 WebKit, 4 iPhone 13) |
...
|---|---|---|---|
| Unidade e componente | `npm test` | **905 testes** em 85 arquivos | Dinheiro, datas no fuso da clínica, CPF, CSV, erros do banco, login e redirecionamento, middleware, cabeçalhos de segurança, **50 das 53 ações de servidor** com um Supabase falso e componentes (jsdom + Testing Library) |
